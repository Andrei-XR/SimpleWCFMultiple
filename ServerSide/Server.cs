...
namespace ServerSide
{
    public class Server
    {
        private string _serverBaseAddress = "net.tcp://127.0.0.1:12345/SimpleWFCMultiple/";
        private List<ServiceHost> ServiceHostList { get; set; }
        ...
        public void CreateServicesByType(Type service)
        {
            ...
            serviceHost.AddServiceEndpoint(service.GetInterface("I" + service.Name), new NetTcpBinding(), serviceAddress);
            serviceHost.Open();
        ...
        public List<Type> GetServiceList()
        {
            return Assembly.GetExecutingAssembly().GetTypes()
                .Where(t => t.Namespace == "ServicerSide.Services")
